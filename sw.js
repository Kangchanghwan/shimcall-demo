...
const CACHE = 'shimcall-v4';
const SHELL = ['./app.html', './css/app.css?v=4', './js/app.js?v=4', './js/store.js?v=4', './js/map-adapter.js?v=4', './js/data.js?v=4', './manifest.json', './icons/icon-192.png'];
